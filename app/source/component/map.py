...
# Preserve the old definitions for legacy utilities, not the adventure entry.
LEGACY_LEVEL_MAP_DATA = LEVEL_MAP_DATA
from .custom_campaign import map_for
LEVEL_MAP_DATA = (None,) + tuple(map_for(stage) for stage in range(1, 6))
