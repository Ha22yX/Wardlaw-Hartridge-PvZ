...
PLANT_CARD_INFO = (  # 元组 (植物名称, 卡片名称, 阳光, 冷却时间)
    ...
    # 笑魇魔藤：跨行追踪，单体输出接近普通豌豆
    (
        GRINDEVOURER := 'GrinDevourer',
        CARD_GRINDEVOURER := 'card_grindevourer',
        100,
        7500,
    ),
    (GASSUNFLOWER := 'GasSunFlower', CARD_GASSUNFLOWER := 'card_gassunflower', 50, 7500),
    (PORTRAITTALLNUT := 'PortraitTallNut', CARD_PORTRAITTALLNUT := 'card_portraittallnut', 125, 30000),
    (PORTRAITCHERRYBOMB := 'PortraitCherryBomb', CARD_PORTRAITCHERRYBOMB := 'card_portraitcherrybomb', 150, 50000),
    (HEADPHONEBOXER := 'HeadphoneBoxer', CARD_HEADPHONEBOXER := 'card_headphoneboxer', 150, 7500),
    (PORTRAITPOTATOMINE := 'PortraitPotatoMine', CARD_PORTRAITPOTATOMINE := 'card_portraitpotatomine', 25, 30000),
    (PORTRAITSQUASH := 'PortraitSquash', CARD_PORTRAITSQUASH := 'card_portraitsquash', 50, 30000),
...
# Shared by card art, tooltips, tutorial dialogue and reward cards.
# Keep internal IDs stable for saved games and asset lookup.
PLANT_DISPLAY_NAMES = {
    GRINDEVOURER: '笑面猎手',
    GASSUNFLOWER: '噗噗金芽',
    PORTRAITTALLNUT: '铁壁阿坚',
    PORTRAITCHOMPER: '黑洞饭桶',
    PORTRAITCHERRYBOMB: '双生爆果',
    PORTRAITPOTATOMINE: '潜地闷雷',
    HEADPHONEBOXER: '耳机拳王',
    PORTRAITSQUASH: '暴躁泰山',
    PORTRAITHEALER: '春风卷卷',
...
PORTRAITTALLNUT_HEALTH = 4500
HEADPHONEBOXER_HEALTH = 300
HEADPHONEBOXER_COMBO_MS = 1400
HEADPHONEBOXER_HITS = ((250, 20), (550, 20), (900, 40))
# One extra grid of reach: boxer -> adjacent nut -> biting zombie.
HEADPHONEBOXER_FRONT_RANGE = 220
HEADPHONEBOXER_BACK_RANGE = 112
PORTRAITHEALER_HEALTH = 300
PORTRAITHEALER_FIRST_HEAL_DELAY = 2000
PORTRAITHEALER_INTERVAL = 15000
PORTRAITHEALER_FRACTION = .25
# Cap tank healing and share a recipient cooldown across all healers.
PORTRAITHEALER_MAX_HEAL = 150
PORTRAITHEALER_RECIPIENT_COOLDOWN = 15000
...
GRINDEVOURER_HEALTH = PLANT_HEALTH
GRINDEVOURER_DAMAGE = 20
GRINDEVOURER_SHOOT_INTERVAL = 1600
GRIN_SEED_SPEED = 300  # pixels per second
GRIN_SEED_LIFETIME = 5000
GASSUNFLOWER_HEALTH = PLANT_HEALTH
GASSUNFLOWER_FIRST_SUN_DELAY = 6000
GASSUNFLOWER_SUN_INTERVAL = 20000
GASSUNFLOWER_SUN_COUNT = 1
GRIN_SEED = 'GrinSeed'
...
PORTRAIT_ZOMBIE = 'PortraitZombie'
ELITE_PORTRAIT_ZOMBIE = 'ElitePortraitZombie'
ELITE_PORTRAIT_HEALTH = 450
ELITE_PORTRAIT_DAMAGE = 60
ELITE_PORTRAIT_SPAWN_EVERY = 8
...
CREATE_ZOMBIE_DICT = {  # 生成僵尸:(级别, 权重)
    PORTRAIT_ZOMBIE: (1, 0),  # 所有出怪在生成入口替换为头像僵尸；保留原权重和波次数量
...
# 记录本地存储文件初始值
CUSTOM_CAMPAIGN_VERSION = 'custom campaign version'
CUSTOM_CAMPAIGN_CLEARED = 'custom campaign cleared'
CUSTOM_ENDLESS_BEST = 'custom endless best'
INIT_USERDATA = {
    LEVEL_NUM: 1,
    CUSTOM_CAMPAIGN_VERSION: 1,
    CUSTOM_CAMPAIGN_CLEARED: 0,
    CUSTOM_ENDLESS_BEST: 0,
    LITTLEGAME_NUM: 1,
    LEVEL_COMPLETIONS: 0,
